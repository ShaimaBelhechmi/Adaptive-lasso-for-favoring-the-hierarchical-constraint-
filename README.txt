Source code for manuscript "Favoring the hierarchical constraint in penalized survival models for randomized trials in precision medicine" Shaima Belhechmi, Gwénaël Le Teuf, Riccardo De Bin, Federico Rotolo & Stefan Michiels.
